...
namespace AplicacionSeguimiento.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idTipoUsuario,tipoUsuario1")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idTipoUsuario,tipoUsuario1")] TipoUsuario tipoUsuario)
        {
            if (ModelState.IsValid)
            {
